      ...
      <Card className="shadow-xl rounded-t-none">
        <CardContent className="p-12">
          <div className="text-center mb-12">
            <h1 className="text-3xl font-bold text-gray-900 mb-4 text-balance">Create new Pass account</h1>
          ...
          <div className="border-t-2 border-gray-100 pt-12">
            ...
            <p className="text-center text-gray-600 text-lg leading-relaxed">
              On the initial start-up screen, tap <span className="font-semibold text-red-600">&quot;Sign Up&quot;</span> button
              to create new account
            </p>

            <div className="flex justify-center mt-8">
              <div className="bg-gray-100 px-4 py-2 rounded-lg border-2 border-dashed border-gray-300">
                <span className="text-sm text-gray-500 font-mono">pass.signup</span>
              </div>
            </div>
          </div>
