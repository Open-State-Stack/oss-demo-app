    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md space-y-6">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Partner Demo Portal</h1>
          <p className="text-gray-600">Experience Digital Pass SSO Integration</p>
        </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <Button 
              ...
              className="w-full h-14 text-left justify-start space-x-4"
              size="lg"
            >
              ...
              <div className="text-left">
                <div className="font-semibold">Login with Digital Pass</div>
                <div className="text-sm opacity-90">Secure mobile authentication via push notification</div>
              </div>
            </Button>
